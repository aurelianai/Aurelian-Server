...
<div class="max-w-xl p-4 mx-auto shadow-xl rounded-xl bg-secondary-300-600-token card">
	<div class="flex flex-col items-center space-y-4">
		<p class="font-medium h6">You have no messages! Try one of these to start.</p>
