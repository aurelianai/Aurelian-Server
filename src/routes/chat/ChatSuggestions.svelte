<script>
	...
	let sample_messages = [
		...
		{ message: 'Write a poem about Bitcoin.', copied: false },
		{
...
<div class="flex flex-col items-center space-y-4">
	<p>You have no messages! Try one of these to start.</p>
	<div class="max-w-xl p-4 card lg:max-w-3xl">
